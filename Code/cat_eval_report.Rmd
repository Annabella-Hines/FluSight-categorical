...
knit: (function(inputFile, encoding) { 
          rmarkdown::render(inputFile,
                        encoding=encoding, 
                        output_file= paste0("C:/Users/",Sys.info()["user"],"/Desktop/GitHub/Flu-Visualizations/Dashboard R Code/Categorical_trends/reports/FluSight_Categorical_eval",format(Sys.Date(), '%Y-%m-%d' ),".html"), 
                        envir = globalenv()) })
...
<script>
   $(document).ready(function() {
     $head = $('#header');
     $head.prepend('<img src=\"https://github.com/cdcepi/FluSight-manuscripts/blob/main/images/FluSightFINAL_thin.jpg?raw=true\" style=\"float: left; padding:0px; width: 100%;\"/>')
   });
</script>

<style>
body {
  background-image: url('https://github.com/cdcepi/FluSight-manuscripts/blob/main/images/FluSightBkgd2.jpg?raw=true');
...
files_path <- paste0("C:/Users/", Sys.info()["user"], "/Desktop/Github/Flu-Visualizations/Dashboard R Code/Categorical_trends")
